...
<?php require( make_get_plugin_directory() . '/inc/builder/core/templates/overlay-header.php' ); ?>
<?php require( make_get_plugin_directory() . '/inc/builder/core/templates/overlay-footer.php' ); ?>
</div>
</script>
